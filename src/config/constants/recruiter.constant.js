...
export const APP_STATUS_DISPLAY_CONFIG = [
  { key: "PENDING",   label: "Chờ xét duyệt", icon: Clock,        color: "text-gray-500",   bg: "bg-gray-50"   },
  { key: "REVIEWING", label: "Đang xem xét",  icon: Clock,        color: "text-yellow-600", bg: "bg-yellow-50" },
  { key: "INTERVIEW", label: "Phỏng vấn",     icon: CheckCircle2, color: "text-blue-600",   bg: "bg-blue-50"   },
  { key: "ACCEPTED",  label: "Đã nhận",       icon: CheckCircle2, color: "text-green-600",  bg: "bg-green-50"  },
  { key: "REJECTED",  label: "Từ chối",       icon: XCircle,      color: "text-red-500",    bg: "bg-red-50"    },
];

export const JOB_STATUS_DISPLAY_CONFIG = [
  { key: "PUBLISHED", label: "Đang tuyển", color: "bg-green-100 text-green-700" },

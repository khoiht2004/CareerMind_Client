      ...
      <div className="mx-auto max-w-6xl px-4">
        ...
        <div className="bg-card overflow-hidden rounded-tr-xl rounded-b-xl p-8">
          <div className="grid items-center gap-8 md:grid-cols-2">
            ...
            <div className="bg-muted/70 text-muted-foreground max-h-56 overflow-hidden rounded-xl text-center">
              <img src={hotlineImg} alt="Ảnh nhân viên tư vấn" />
            </div>
          </div>
        </div>
      </div>

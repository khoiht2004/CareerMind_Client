      ...
      <div className="mx-auto grid max-w-6xl items-center gap-8 px-4 lg:grid-cols-[1fr_280px_1fr]">
        <div>
          ...
          <p className="mt-3 text-sm font-semibold">
            Ghi nhận sự tương tác thường xuyên của Nhà tuyển dụng với CV ứng
            viên
          </p>
          <div className="bg-primary mt-5 w-full rounded-lg px-5 py-3 text-base font-black sm:w-fit sm:text-lg">
            3.523 tin đăng được tương tác trong 24 giờ qua
          </div>
          <p className="mt-7 text-sm font-bold tracking-[0.25em] sm:tracking-[0.45em]">
          ...
          <div className="mt-4 flex flex-wrap gap-3 sm:gap-4">
            {["09 Giờ", "06 Phút", "23 Giây"].map((item) => (
              <div
                key={item}
                className="bg-primary/40 rounded-lg px-4 py-3 text-center"
              >
        ...
        <div className="text-center">
          ...
          <Button className="bg-primary hover:bg-primary/90 mt-4 px-8 sm:px-10">
